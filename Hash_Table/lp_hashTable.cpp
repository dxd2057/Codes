...
/**
 * @brief Construct a new Linear Probing Hash Table:: Linear Probing Hash Table object
 */
int main() {
    LinearProbingHashTable hashTable; // Create a hash table with 11 buckets

    Node students[11]; // Create an array of 11 students

    srand(time(nullptr));
    for (int i = 0; i < 11; ++i) { // Generate 11 random students and push them into the hash table
        std::string key = "";
        key += generateKey();
